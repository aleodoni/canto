# -*- coding: utf-8 -*-
"""
Django settings for Canto dos Encantos project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (canto/config/settings/base.py - 3 = canto/)
APPS_DIR = ROOT_DIR.path('canto')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///canto'),
}
